...
class SAN(nn.Module):
	def __init__(self, input_img_size, input_ques_size, att_size, output_size, input_text_size=None):
	...
	def forward(self, ques_feats, img_feats, text_feats = None):  # ques_feats -- [batch, d] | img_feats -- [batch_size, img_seq_size/max_num_bars, input_img_size] | text_feats -- [batch_size,max_num_text,input_text_size]
