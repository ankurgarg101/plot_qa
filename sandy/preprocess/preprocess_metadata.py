...
def _parse_args():
    ...
    parser.add_argument('--input_metadata', type=str, default='../../../data/metadata/train_metadata.json', help='path to input metadata file')

    parser.add_argument('--output_metadata', type=str, default='../../../data/metadata/out_train_metadata.json', help='path to output metadata file')
